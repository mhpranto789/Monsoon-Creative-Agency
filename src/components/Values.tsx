      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          {VALUES_DATA.map((value, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-white dark:bg-[#0E0F12] border border-gray-150 dark:border-white/10 p-8 flex flex-col justify-between hover:border-[#e83e27] dark:hover:border-[#e83e27] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 rounded-none overflow-hidden"
              >
                ...
                <div className="space-y-6 relative z-10">
                  {/* Floating Icon Box */}
                  <div className="w-12 h-12 bg-black dark:bg-[#1C1C1C] text-white dark:text-gray-250 group-hover:bg-[#e83e27] dark:group-hover:bg-[#e83e27] duration-300 flex items-center justify-center rounded-none">
                    <IconComponent size={24} className="group-hover:rotate-12 transition-transform duration-300" />
                  </div>

                  {/* Text Container */}
                  <div className="space-y-2">
                    <h3 className="font-display font-black text-2xl text-black dark:text-white group-hover:text-[#e83e27] transition-colors">
                      {value.title}
                    </h3>
        ...
        <div className="mt-20 border border-neutral-200 dark:border-white/10 bg-[#121212] dark:bg-[#0E0F12] p-10 md:p-16 flex flex-col md:flex-row justify-between items-center gap-8 relative overflow-hidden transition-colors shadow-lg">
          <div className="space-y-3 relative z-10 max-w-xl text-center md:text-left">
            <span className="font-mono text-[9px] text-[#e83e27] tracking-widest font-bold uppercase py-1 px-3 bg-white/10 dark:bg-white/5 rounded-none inline-block">
